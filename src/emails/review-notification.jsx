...
export default function ReviewNotification({
  ...
  return (
    <Html>
      {" "}
      <Head /> <Preview>New review from {name}</Preview>{" "}
      <Body style={main}>
        {" "}
        <Container style={container}>
          ...
          <Section style={section}>
            {" "}
            <Text style={label}>Name</Text> <Text style={value}>{name}</Text>{" "}
            ...
            <Text style={value}>&ldquo;{content}&rdquo;</Text>{" "}
          </Section>{" "}
          <Hr style={hr} />{" "}
          <Text style={footer}>
            {" "}
