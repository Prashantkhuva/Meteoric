  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] flex items-center justify-center px-6">
      ...
      <div className="relative z-10 text-center max-w-lg">
        <p className="text-[var(--text-muted)] text-[8rem] md:text-[10rem] font-bold leading-none mb-4 select-none">
          404
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {suggestions.map((s) => (
            <Link
              key={s.href}
              href={s.href}
              className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full border border-[var(--border-color)] bg-[var(--text-primary)]/[0.03] text-[var(--text-secondary)] text-sm font-medium hover:text-[var(--text-primary)] hover:border-[var(--border-hover)] hover:bg-[var(--text-primary)]/[0.06] transition-all duration-200"
            >
              {s.label}
