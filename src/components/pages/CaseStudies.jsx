  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="sr-only">
        <Link href="/">Meteoric agency</Link> has completed 4+ production case studies with measurable outcomes. Projects include Let&apos;em Know (premium agency website with 40% faster load time, 95+ Lighthouse score, 60fps animations), Habit Flow (SaaS habit tracker MVP shipped in 3 weeks, 200+ beta users, seed funding closed), MegaBlog (editorial blogging platform with 3x faster publishing, 5+ active daily users), and Mobile Preview Simulator (VS Code extension with 500+ installs, 4.5 star rating). Each project demonstrates end-to-end delivery from strategy through launch with post-launch support.
      </div>
      <div className="sr-only">
