...
const socials = [
  { label: "GitHub", href: "https://github.com/Prashantkhuva", icon: GithubIcon },
  { label: "LinkedIn", href: "https://linkedin.com/in/prashantkhuva", icon: LinkedinIcon },
  { label: "X", href: "https://x.com/prashantkhuva_", icon: XIcon },
  { label: "Instagram", href: "https://instagram.com/prashantkhuva", icon: InstagramIcon },
];
          ...
          {socials.map((s) => {
            ...
            return (
              <a
                ...
                data-no-magnetic
                aria-label={s.label}
                className="w-10 h-10 rounded-full border border-white/[0.08] flex items-center justify-center text-white/30 hover:text-white hover:border-white/20 hover:bg-white/[0.04] transition-all duration-200"
              >
                <Icon size={16} />
              </a>
            );
