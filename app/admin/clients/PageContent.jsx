            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center gap-2 border-t border-white/[0.06] pt-4">
                ...
                <button
                  ...
                  className="ml-auto inline-flex items-center gap-2 border border-red-500/10 bg-red-500/5 px-4 py-2.5 text-xs font-medium text-red-400/60 transition-all hover:bg-red-500/10 hover:text-red-400 disabled:opacity-40 disabled:pointer-events-none"
                >
                  {deleteLoading ? <span className="h-3 w-3 animate-spin rounded-full border border-white/20 border-t-[#EAEFFF]/60 inline-block" /> : <Trash2 size={13} />}
