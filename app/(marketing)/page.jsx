...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${SITE_URL}/api/og?title=${encodeURIComponent(pageTitle)}&description=${encodeURIComponent(pageDesc)}&type=home`,
        width: 1635,
        height: 962,
  ...
  twitter: {
    ...
    title: pageTitle,
    description: pageDesc,
    images: [`${SITE_URL}/api/og?title=${encodeURIComponent(pageTitle)}&description=${encodeURIComponent(pageDesc)}&type=home`],
