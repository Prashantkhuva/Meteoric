        ...
        <div className="relative max-w-6xl mx-auto px-6 md:px-12 pt-32 pb-24">
          ...
          <section className="mb-28">
            ...
            <Link
              ...
              className="group relative block overflow-hidden rounded-2xl border border-white/[0.06] hover:border-[#EAEFFF]/[0.12] bg-[#0a0a0a] transition-all duration-500 hover:shadow-[0_0_60px_rgba(234,239,255,0.03)]"
            >
              {/* Corner glow */}
