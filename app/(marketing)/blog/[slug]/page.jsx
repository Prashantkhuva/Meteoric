          ...
          <header className="mb-16 md:mb-20">
            ...
            <div className="flex flex-wrap items-center gap-4 text-[11px] font-mono tracking-wider">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-white/45 block leading-none mb-1">
                    Prashant Khuva
                  </span>
                ...
                {post.faqs.map((faq, i) => (
                  ...
                  >
                    <div className="flex items-start gap-4 mb-3">
                      <span className="text-[#EAEFFF]/30 text-sm font-mono shrink-0 mt-0.5 tabular-nums">
                        Q{i + 1}
                      </span>
                      <h3 className="text-base md:text-lg font-medium text-white/70 leading-[1.4]">
                        {faq.question}
                      </h3>
                    </div>
                    <div className="flex items-start gap-4 pl-9">
                      <p className="text-white/30 text-[15px] leading-[1.8] font-[350]">
                        {faq.answer}
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="relative">
                      <div className="flex items-center gap-2 mb-3">
                        {rp.tags.slice(0, 1).map((t) => (
                          <span
                            key={t}
                            className="text-[9px] font-mono tracking-wider text-white/20 bg-white/[0.03] border border-white/[0.05] px-1.5 py-0.5 rounded-full"
                          >
                            {t}
                          </span>
                        ))}
