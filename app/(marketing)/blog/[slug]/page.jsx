    ...
    <>
      ...
      <article className="min-h-screen bg-[#070707] text-white">
        ...
        <div className="relative max-w-4xl mx-auto px-6 md:px-12 pt-32 pb-24">
            ...
            <div className="mt-24 pt-16 border-t border-white/[0.05] max-w-3xl">
              ...
              <div className="space-y-4">
                {post.faqs.map((faq, i) => (
                  <div
                    key={i}
                    className="group p-6 md:p-8 rounded-xl bg-[#0a0a0a] border border-white/[0.05] hover:border-white/[0.08] hover:shadow-[0_0_30px_rgba(234,239,255,0.02)] transition-all duration-400"
                  >
              ...
              <div className="space-y-3">
                {post.furtherReading.map((link, i) => (
                  <a
                    ...
                    className="group flex items-center gap-3 p-4 rounded-xl bg-[#0a0a0a] border border-white/[0.05] hover:border-white/[0.1] hover:shadow-[0_0_20px_rgba(234,239,255,0.02)] transition-all duration-300"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {relatedPosts.map((rp) => (
                  <Link
                    key={rp.slug}
                    href={`/blog/${rp.slug}`}
                    className="group relative p-6 rounded-xl bg-[#0a0a0a] border border-white/[0.05] hover:border-[#EAEFFF]/[0.1] hover:shadow-[0_0_30px_rgba(234,239,255,0.02)] transition-all duration-400 overflow-hidden"
                  >
          ...
          {/* ═══ CTA ═══ */}
          <div className="relative mt-24 p-8 md:p-14 rounded-2xl bg-[#0a0a0a] border border-white/[0.05] max-w-3xl overflow-hidden hover:border-white/[0.08] transition-all duration-500">
